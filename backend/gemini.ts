...
<p>{{HNコメントの総括。議論全体の論調・主要な論点・意見の対立や合意を2〜4文でまとめる。記事の文体・AI生成の疑い・paywall・タイトルの釣りなど記事の内容そのものではないメタな指摘は、コメントのおおよそ5割以上を占める場合に限り末尾に1文だけ添え、それ未満なら一切言及しない。メタな指摘への言及だけで総括を構成することは厳禁。}}</p>
